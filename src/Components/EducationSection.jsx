...
import remove from "../assets/final.jpg";
...
const EarlyLifeSection = () => {
    return (
        <div className="flex flex-col md:flex-row bg-[#111111] text-white md:h-screen">
            ...
            {/* Right side - Image */}
            <motion.div 
                className="w-full md:w-2/5 hidden md:flex pl-[10px] h-full relative" 
